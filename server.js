...
app.get('/api/menu', async (req, res) => {
    ...
    const url = `https://www.swiggy.com/dapi/menu/pl?page-type=${page_type}&complete-menu=${complete_menu}&lat=${lat}&lng=${lng}&restaurantId=${restaurantId}&catalog_qa=undefined&submitAction=${submitAction}`
...
app.get('/', (req, res) => {
    res.json({ "test": "Welcome to TasteTrek! - See Live Web URL for this Server - https://tasteTrek-app.netlify.app" });
})
